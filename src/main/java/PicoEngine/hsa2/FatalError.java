 ...
 * <br>
 *   https://github.com/salamander2/PicoEngine.hsa2
 * <p>
 * @author Tom West
 * @author Michael Harwood
 * @version 4.4
 * Changes: switch to using JOptionPane and remove CloseableDialog.java
 * 			change accessibility from public to default so that it can only be called by other PicoEngine.hsa2 classes.
 */
