...
public class GraphicsConsole extends JFrame implements MouseListener, MouseMotionListener, MouseWheelListener, ComponentListener {
	...
	private static final String DEFAULT_NAME = "PicoEngine.hsa2 Graphics Console";
	 ...
	 * invokeAnd Wait() is used to make PicoEngine.hsa2 thread safe, since Timers can be used to update graphics.
